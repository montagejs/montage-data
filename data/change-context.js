...
var logger = require("montage/core/logger").logger("change-context");
/**
 @class module:montage/data/change-context.ChangeContext
 @extends module:montage/data/store.Store
 */
var ChangeContext = exports.ChangeContext = Store.specialize(/** @lends module:montage/data/change-context.ChangeContext# */ {
        ...
        value: function(instance) {
            if (instance !== null) {
                if (typeof instance.context === "undefined") {
                    ...
                    if (blueprint !== null) {
                        DataObjectProperty.manager.apply(Object.getPrototypeOf(instance), blueprint);
                    } else {
