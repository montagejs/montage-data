 ...
 */
var Operation = exports.Operation = Montage.specialize(/** @lends module:montage/data/operation.Operation# */ {
    ...
    createNoopOperation:{
        value:function () {
            if (_noopOperation === null) {
                _noopOperation = Object.freeze(NoopOperation.create().init());
            }
