...
var logger = require("montage/core/logger").logger("pledge");
/**
 ...
 */
var Pledge = exports.Pledge = Montage.specialize(/** @lends module:montage/data/pledge.Pledge# */ {
 ...
 */
var PledgedSortedSet = exports.PledgedSortedSet = Pledge.specialize(/** @lends module:montage/data/pledge.PledgedSortedSet# */ {

    constructor: {
        value: function PledgedSortedSet() {
            this.super();
        }
    },
