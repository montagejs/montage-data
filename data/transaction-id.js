...
var logger = require("montage/core/logger").logger("transaction-id");
/**
 @private
 */
 ...
 */
var TransactionId = exports.TransactionId = Montage.specialize(/** @lends module:montage/data/transaction-id.TransactionId# */ {
 ...
 */
var TransactionManager = exports.TransactionManager = Montage.specialize(/** @lends module:montage/data/transaction-id.TransactionManager# */ {

    constructor: {
        value: function TransactionManager() {
            this.super();
        }
    },
