...
var logger = require("montage/core/logger").logger("mapping");
/**
 ...
 */
var Mapping = exports.Mapping = Montage.specialize(/** @lends module:montage/data/mapping.Mapping# */ {
 ...
 */
var MappingSet = exports.MappingSet = Mapping.specialize(/** @lends module:montage/data/mapping.MappingSet# */ {

    constructor: {
        value: function MappingSet() {
            this.super();
        }
    },
 ...
 * A binder mapping is an abstract class that is defined by each access store to represent the way to way to access a the backing store.
 ...
 @extends module:montage/data/mapping.Mapping
 */
var BinderMapping = exports.BinderMapping = Mapping.specialize(/** @lends module:montage/data/mapping.BinderMapping# */ {

    constructor: {
        value: function BinderMapping() {
            this.super();
        }
    },
    ...
    createConnectionInformation: {
        value: function () {
            // TODO [PJYF June 19 2013] This need to be coverted to the new constructor convention
     ...
     */
    connectionInformationConstructor: {
        value: StoreConnectionInformation
    },
 ...
 * A blueprint mapping is an abstract class that is defined by each access store to represent the way to way to access a the backing store.
 ...
 @extends module:montage/data/mapping.Mapping
 */
var BlueprintMapping = exports.BlueprintMapping = Mapping.specialize(/** @lends module:montage/data/mapping.BlueprintMapping# */ {

    constructor: {
        value: function BlueprintMapping() {
            this.super();
        }
    },
 ...
 * An attribute mapping is an abstract class that is defined by each access store to represent the way to way to access a the backing store.
 ...
 @extends module:montage/data/mapping.Mapping
 */
var AttributeMapping = exports.AttributeMapping = Mapping.specialize(/** @lends module:montage/data/mapping.AttributeMapping# */ {

    constructor: {
        value: function AttributeMapping() {
            this.super();
        }
    },
 ...
 * An association mapping is an abstract class that is defined by each access store to represent the way to way to access a the backing store.
 ...
 @extends module:montage/data/mapping.Mapping
 */
var AssociationMapping = exports.AssociationMapping = Mapping.specialize(/** @lends module:montage/data/mapping.AssociationMapping# */ {

    constructor: {
        value: function AssociationMapping() {
            this.super();
        }
    },
