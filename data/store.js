...
var StoreConnectionInformation = require("data/model/store-connection-information").StoreConnectionInformation;
...
var logger = require("montage/core/logger").logger("store");
 ...
 */
var Store = exports.Store = Montage.specialize(/** @lends module:montage/data/store.Store# */ {
    ...
    /**
     * Returns the binder mapping constructor.<br/>This is intended to be subclassed by concrete store to create the right mapping for their store.
     * @function
     * @returns binder mapping constructor
     */
    binderMappingConstructor: {
        get: function () {
    ...
    /**
     * Returns the blueprint mapping constructor.<br/>This is intended to be subclassed by concrete store to create the right mapping for their store.
     * @function
     * @returns binder mapping constructor
     */
    blueprintMappingConstructor: {
        get: function () {
    ...
    /**
     * Returns the attribute mapping constructor.<br/>This is intended to be subclassed by concrete store to create the right mapping for their store.
     * @function
     * @returns binder mapping constructor
     */
    attributeMappingConstructor: {
        get: function () {
    ...
    /**
     * Returns the association mapping constructor.<br/>This is intended to be subclassed by concrete store to create the right mapping for their store.
     * @function
     * @returns binder mapping constructor
     */
    associationMappingConstructor: {
        get: function () {
 ...
 */
var StoreManager = exports.StoreManager = Store.specialize(/** @lends module:montage/data/store.StoreManager# */ {

    constructor: {
        value: function StoreManager() {
            this.super();
        }
    },
    ...
    blueprintForPrototype: {
        value: function (prototypeName, moduleId) {
            return DataBinder.manager.blueprintForPrototype(prototypeName, moduleId);
        }
    },
            ...
            if (store == null) {
                ...
                if (binderMapping) {
                    ...
                    return require.async(binderMapping.storeModuleId).then(function (exports) {
                            ...
                            return Promise.reject("Could not load the store prototype " + binderMapping.storeModuleId, error);
                        }
                    );
                } else {
                    return Promise.resolve(store);
