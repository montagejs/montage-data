...
describe("data/blueprint-spec", function () {
    describe("Binder", function () {
        ...
        describe("Adding blueprints", function () {
            var binder = new DataBinder().initWithNameAndRequire("CompanyBinder", global.require);

            var personBlueprint = binder.addBlueprintNamed("Person");
            var companyBlueprint = binder.addBlueprintNamed("Company");

            it("should have a binder", function () {
                expect(personBlueprint.binder).toBe(binder);
                expect(personBlueprint instanceof DataBlueprint).toBe(true);
                expect(companyBlueprint.binder).toBe(binder);
                expect(companyBlueprint instanceof DataBlueprint).toBe(true);
            });
    ...
    describe("Blueprint", function () {
        describe("properties", function () {
            var blueprint = new DataBlueprint().initWithName("Person");
        ...
        describe("associations", function () {
            ...
            var personBlueprint = new DataBlueprint().initWithName("Person");
            var companyBlueprint = new DataBlueprint().initWithName("Company");
        ...
        describe("blueprint to instance association", function () {
            var binder = new DataBinder().initWithNameAndRequire("Binder", global.require);
            var personBlueprint = new DataBlueprint().initWithName("Person");
            var companyBlueprint = new DataBlueprint().initWithName("Company");
        ...
        describe("applying a basic blueprint to a prototype", function () {
            ...
            beforeEach(function () {
                var binder = new DataBinder().initWithNameAndRequire("Binder", global.require);
                personBlueprint = new DataBlueprint().initWithNameAndModuleId("Person", "mymodule");
                ...
                binder.addBlueprint(personBlueprint);
                DataBinder.manager.addBinder(binder);
        ...
        describe("adding a Property", function () {
            var circle, context, shapeBlueprint;
            beforeEach(function () {
                var binder = new DataBinder().initWithNameAndRequire("Binder", global.require);
                shapeBlueprint = new DataBlueprint().initWithNameAndModuleId("Shape", "mymodule");
            ...
            describe("mandatory attribute's property", function () {
        ...
        describe("serializing", function () {
            ...
            it("can deserialize", function () {
                ...
                return new Deserializer().init(serializedBinder, require).deserializeObject().then(function (deserializedBinder) {
                    ...
                    expect(serializedBinder).not.toBeNull();
                    expect(metadata.objectName).toBe("DataBinder");
                    expect(metadata.moduleId).toBe("data/model/data-binder");
                    var personBlueprint = deserializedBinder.blueprintForPrototype("Person", "test/data/object/person");
            ...
            describe("create new prototype", function () {
                ...
                it("Should have the right moduleId and Name", function () {
                    var info = Montage.getInfoForObject(Person);
                    expect(info.moduleId).toBe("test/data/object/person");
